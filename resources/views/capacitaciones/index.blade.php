                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-2xl font-bold text-gray-900">{{ $estadisticas['programadas'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-sm font-medium text-gray-500">En Curso</div>
                                <div class="text-2xl font-bold text-gray-900">{{ $estadisticas['en_curso'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4">
                                            ...
                                            @if($capacitacion->instructor)
                                                <div class="text-sm text-gray-500">{{ $capacitacion->instructor }}</div>
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ $capacitacion->fecha_formateada }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ $capacitacion->horario_formateado }}
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            {{ $capacitacion->inscritos_count }}
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('capacitaciones.show', $capacitacion) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Ver</a>
                                            @if($capacitacion->puedeSerModificada())
                                                <a href="{{ route('capacitaciones.edit', $capacitacion) }}" class="text-blue-600 hover:text-blue-900">Editar</a>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
