...
<head>
    ...
    <title>{{ $title ?? 'Trabaja con Nosotros' }} - {{ config('app.name', 'Localizamos TSA') }}</title>
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="{{ $title ?? 'Trabaja con Nosotros' }} - Localizamos TSA">
                ...
                <div class="flex items-center">
                    <a href="{{ route('portal.index') }}" class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-auto" src="/images/logo.png" alt="Localizamos TSA" onerror="this.style.display='none'">
