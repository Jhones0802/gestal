    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('empleados.show', $empleado) }}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="direccion" 
                                          required
                                          rows="3"
                                          class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('direccion') border-red-500 @enderror">{{ old('direccion', $empleado->direccion) }}</textarea>
                                @error('direccion')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="area" 
                                    ...
                                    <option value="">Seleccione...</option>
                                    <option value="Administrativa" {{ old('area', $empleado->area) == 'Administrativa' ? 'selected' : '' }}>Administrativa</option>
                                    <option value="Comercial" {{ old('area', $empleado->area) == 'Comercial' ? 'selected' : '' }}>Comercial</option>
                                    <option value="Técnica" {{ old('area', $empleado->area) == 'Técnica' ? 'selected' : '' }}>Técnica</option>
                                    <option value="Operaciones" {{ old('area', $empleado->area) == 'Operaciones' ? 'selected' : '' }}>Operaciones</option>
                                    <option value="Recursos Humanos" {{ old('area', $empleado->area) == 'Recursos Humanos' ? 'selected' : '' }}>Recursos Humanos</option>
                                    <option value="Contabilidad" {{ old('area', $empleado->area) == 'Contabilidad' ? 'selected' : '' }}>Contabilidad</option>
                                    <option value="Gerencia" {{ old('area', $empleado->area) == 'Gerencia' ? 'selected' : '' }}>Gerencia</option>
                                </select>
                                @error('area')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('fecha_fin_contrato', $empleado->fecha_fin_contrato?->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <select name="estado" 
                                    ...
                                    <option value="liquidado" {{ old('estado', $empleado->estado) == 'liquidado' ? 'selected' : '' }}>Liquidado</option>
                                </select>
                                @error('estado')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="fondo_pension" 
                                       value="{{ old('fondo_pension', $empleado->fondo_pension) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <select name="nivel_educativo" 
                                    ...
                                    <option value="bachillerato" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'bachillerato' ? 'selected' : '' }}>Bachillerato</option>
                                    <option value="tecnico" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'tecnico' ? 'selected' : '' }}>Técnico</option>
                                    <option value="tecnologo" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'tecnologo' ? 'selected' : '' }}>Tecnólogo</option>
                                    <option value="profesional" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'profesional' ? 'selected' : '' }}>Profesional</option>
                                    <option value="especializacion" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'especializacion' ? 'selected' : '' }}>Especialización</option>
                                    <option value="maestria" {{ old('nivel_educativo', $empleado->nivel_educativo) == 'maestria' ? 'selected' : '' }}>Maestría</option>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('titulo_obtenido', $empleado->titulo_obtenido) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       name="institucion" 
                                       value="{{ old('institucion', $empleado->institucion) }}" 
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select name="contacto_emergencia_parentesco" 
                                    ...
                                    <option value="">Seleccione...</option>
                                    <option value="Padre" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Padre' ? 'selected' : '' }}>Padre</option>
                                    <option value="Madre" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Madre' ? 'selected' : '' }}>Madre</option>
                                    <option value="Esposo(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Esposo(a)' ? 'selected' : '' }}>Esposo(a)</option>
                                    <option value="Hermano(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Hermano(a)' ? 'selected' : '' }}>Hermano(a)</option>
                                    <option value="Hijo(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Hijo(a)' ? 'selected' : '' }}>Hijo(a)</option>
                                    <option value="Tío(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Tío(a)' ? 'selected' : '' }}>Tío(a)</option>
                                    <option value="Primo(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Primo(a)' ? 'selected' : '' }}>Primo(a)</option>
                                    <option value="Amigo(a)" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Amigo(a)' ? 'selected' : '' }}>Amigo(a)</option>
                                    <option value="Otro" {{ old('contacto_emergencia_parentesco', $empleado->contacto_emergencia_parentesco) == 'Otro' ? 'selected' : '' }}>Otro</option>
                                </select>
